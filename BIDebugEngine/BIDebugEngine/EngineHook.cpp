...
extern "C" {
    ...
    uintptr_t scriptVMSimulateActual;
}
...
extern "C" void scriptVMSimulate();
...
//146114 0000000000DE05C0 Not constructor! This adds to world vm list
HookManager::Pattern pat_scriptVMConstructor{
    "xxxx?xxxx?xxxx?xxxxxxxxxxxxxxxxxxxxxxxx????xxxxxxxxxxxxx????xxxxxxxxxxxxxxxxxxxxxxxxxxxxx????xxxxxxxxxxxxxxxxxxxxxxxxxxx?????xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx????xxxxxxx????xxxx????xxxxxx????xxxxxx????xxxx?xxxx?xxxx?xxxxxx",
    ""
};

//146114 13504D0
HookManager::Pattern pat_scriptVMSimulate{
    "xxxxxxxx?????xxxx?xxxxxxxxxxxxxx?xxxxxxxxxx?xxxx????xxxx????xxx????xxxxxxxx????xxxxx????xx",
    ""
};


//146113 140FC90
HookManager::Pattern pat_scriptVMSimulate_prof{
    "xxxxxxxx?xxx????xx?????xxxx?xxxxxxxxxxxxxx?xxx????xxxxxx????xxxx????xxxx????xxxxxxxxx????xxxx????xxxxxxxxxx????xx????xx????xxx????xxx????xxx????xxx????xxx????xxxxxxxxx????xxx????xxx????xx????x????xx?????xx????xxx????xxxx????xx?????xxxxxxxxxxxxxxxx????xxxxxxxx????xx????xxxxx????xxxxxxxxxxxxxxxxxxxxxx????xxxxxxxxxxxxxxxxx????xxx????xx????xxxxxxxx????xxxxxxxxxxxxxxxxxx????xxx????xxxxx????xxxxxxxxxxxxxxx",
    ""
};
...
HookManager::Pattern pat_scriptVMSimulateEnd{
    "xxxxxxx????xxxxxxx?x????xxx????xxxx????xxx????xxx????xxxx????xxxxxxxxxxxx????xxxx?xxxxxxxxxxxxxxxxxxxxx????xxxx?xxxxxxxxxx",
    "",
    0x1350623  - 0x13505C0
};
...
void EngineHook::placeHooks() {
    ...
    auto vers = intercept::sqf::product_version();
    bool IsProfiling = vers.branch == "Profile";
    ...
    HI.__scriptVMConstructor = GlobalHookManager.placeHook(hookTypes::scriptVMConstructor, pat_scriptVMConstructor, reinterpret_cast<uintptr_t>(scriptVMConstructor), scriptVMConstructorJmpBack, 6);
    ...
    HI.__scriptVMSimulateEnd = HI.__scriptVMSimulateStart = GlobalHookManager.placeHookTrampoline(hookTypes::scriptVMSimulateStart, IsProfiling ? pat_scriptVMSimulate_prof : pat_scriptVMSimulate, reinterpret_cast<uintptr_t>(scriptVMSimulate), scriptVMSimulateActual, IsProfiling ? 0x22 : 0x18);

    //HI.__worldSimulate = GlobalHookManager.placeHook(hookTypes::worldSimulate, pat_worldSimulate, reinterpret_cast<uintptr_t>(worldSimulate), worldSimulateJmpBack, 0);
...
void EngineHook::_scriptTerminated(uintptr_t scrVMPtr) {
    ...
    if (scVM->_context.callstack.count() > 1) {
